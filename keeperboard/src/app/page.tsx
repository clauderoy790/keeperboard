      ...
      <main className='container mx-auto px-4 py-20'>
        <div className='max-w-4xl mx-auto text-center'>
          <h1 className='text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6'>
            Free Leaderboards for{' '}
            <span className='text-indigo-600 dark:text-indigo-400'>
              Indie Games
            </span>
          </h1>
          <p className='text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto'>
            Add competitive leaderboards to your game in minutes. No credit
            card, no servers, no hassle. Built for indie developers who want to
        ...
        <div className='mt-24 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto'>
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Add leaderboards to your Phaser, Unity, or any web game with our
              TypeScript SDK. 5 minutes from signup to live leaderboard.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Separate dev, staging, and production leaderboards. Test without
              polluting your live data. Just like the big platforms.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              View scores, manage players, import existing data, and monitor
              your game's competitive scene from a clean web interface.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              API key authentication, rate limiting, and proper input
              validation. Your leaderboards are protected from spam and abuse.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Importing from Unity Gaming Services or another platform? Upload
              CSV/JSON and migrate your existing leaderboards in seconds.
            </p>
          </div>
        </div>
        ...
        <div className='mt-24 max-w-3xl mx-auto text-center bg-indigo-600 dark:bg-indigo-700 p-12 rounded-2xl'>
          ...
          <p className='text-indigo-100 mb-8 text-lg'>
            Join indie developers who are building competitive experiences
