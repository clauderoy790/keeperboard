  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card glowEffect className="transform hover:scale-105 transition-transform duration-300">
        ...
        <Card glowEffect className="transform hover:scale-105 transition-transform duration-300" style={{ animationDelay: '100ms' }}>
          <div className="text-center">
            <div className="text-5xl font-mono font-bold text-cyan-400 mb-2">
        ...
        <Card glowEffect className="transform hover:scale-105 transition-transform duration-300" style={{ animationDelay: '200ms' }}>
          <div className="text-center">
            <div className="text-5xl font-mono font-bold text-cyan-400 mb-2">
      ...
      {totalGames === 0 ? (
        ...
        >
          <div className="py-8">
            <div className="mb-6">
              <svg className="w-24 h-24 mx-auto text-cyan-500/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
